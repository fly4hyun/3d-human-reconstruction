...
from models_SMPL_ICON.imutils import uncrop
from renderlib.render_utils import Pytorch3dRasterizer, face_vertices
...
def remesh(obj_path, perc, device):
    ...
    ms.save_current_mesh(obj_path.replace("recon", "remesh").replace("2_ICON", "3_ICON"))
    polished_mesh = trimesh.load_mesh(obj_path.replace("recon", "remesh").replace("2_ICON", "3_ICON"))
