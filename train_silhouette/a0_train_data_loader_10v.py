...
class TestDataset():
    ...
    def __getitem__(self, index):
        ...
        img_4, img_hps, img_ori, img_mask, uncrop_param = process_image(img_path + '_4.png', 'pymaf', 512)
        img_5, img_hps, img_ori, img_mask, uncrop_param = process_image(img_path + '_5.png', 'pymaf', 512)
        img_6, img_hps, img_ori, img_mask, uncrop_param = process_image(img_path + '_6.png', 'pymaf', 512)
        img_7, img_hps, img_ori, img_mask, uncrop_param = process_image(img_path + '_7.png', 'pymaf', 512)
        ...
        data_dict = {
            ...
            'image_4' : img_4.unsqueeze(0), 
            'image_5' : img_5.unsqueeze(0), 
            'image_6' : img_6.unsqueeze(0), 
            'image_7' : img_7.unsqueeze(0), 
            'face' : mesh_face, 
            'verts' : mesh_vert,
